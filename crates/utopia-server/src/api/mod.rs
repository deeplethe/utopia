...
pub fn router(state: AppState, cfg: &AppConfig) -> Router {
    let api = Router::new()
        ...
        .route(
            ...
            axum::routing::put(datasource_routes::mount)
                .delete(datasource_routes::unmount),
        )
        .route(
        ...
        .route(
            ...
            patch(ontology_routes::update_entity_type)
                .delete(ontology_routes::delete_entity_type),
        )
        .route(
        ...
        .route(
            "/kbs/{id}/review/{review_id}",
            post(review_routes::decide),
        )
        .route(
        ...
        .route("/kbs/{id}/entities/merge", post(review_routes::manual_merge))
        .route(
