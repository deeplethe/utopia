...
[![Official site](https://img.shields.io/badge/OFFICIAL-UTOPIA.BI-FFFFFF?style=flat-square&labelColor=161B22&logo=data:image/svg%2Bxml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI%%2BPC9zdmc%2BCg%3D%3D&logoColor=FFFFFF)](https://utopia.bi)
...
我们的愿景是建立一个知识世界模型，它理解企业中的人、事、规则与关系，理解它们如何随时间变化、为何成立、何时失效，每一个决策如何产生，决策带来的收益，因与果，一切的一切。我们给它取了一个稍显浪漫的名字——**乌托邦（Utopia）**，一个知识的枢纽，一个决策的基座，一个受控执行的闸门，或是推演未来的试验场。

要维持一个理想世界当然需要一些伟大的设计，限于篇幅，这里仅展开讲系统独特的时间感知功能：托勒密的地心体系曾被视作对宇宙秩序的合理解释，后来被哥白尼、开普勒、伽利略与牛顿一步步修正和取代。——你看，我们记住的不止是「哦！日心说是对的」，而是整个认知的变化过程，是一个完整的历史。
