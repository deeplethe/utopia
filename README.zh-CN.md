...
我们想搭建的，是一个属于企业自己的世界模型。它知道企业里有哪些人、哪些事、哪些规则与关系；知道什么正在发生，什么曾经发生；知道一件事为什么成立，又会因为什么而失效。现实不断向前，它也随之演化。

所以我们给它取了一个稍显浪漫的名字：**乌托邦（Utopia）**。若要一个工程上的说法，它是一个被动演化的企业世界模型——不凭空创造世界，而是持续观察现实、吸收事实、记录变化，在一次次事件之后重新理解自己所处的世界。记忆、知识、规则、时间、推理与行动，都只是它的一部分。
