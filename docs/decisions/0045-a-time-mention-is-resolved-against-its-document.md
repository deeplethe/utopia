...
- **Status**: Proposed 2026-09-16 · nothing built · expands decision 5 of [0044](0044-the-ontology-is-a-view-over-what-documents-say.md) and revises decision 3 of [0022](0022-an-unknown-date-is-not-an-open-one.md) for undated documents · closes #714 when cut 2 lands
