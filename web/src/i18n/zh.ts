...
export const zh: Strings = {
  ...
  ontology: {
    ...
    schemaAllClasses: (n) => `全部 ${n} 个类`,
    schemaScopeInUseHint: "画的是有实例的类及其祖先。点一下看整个本体。",
    schemaScopeTopHint: "还没有类有实例，画的是层级最上面两层。点一下看整个本体。",
    schemaScopeAllHint: "画的是全部的类。点一下回到库用到的那些。",
    schemaClosePanel: "关闭",
